  ...
  return (
    <div className="w-full max-w-7xl bg-showcase-background text-showcase-foreground rounded-showcase-lg shadow-showcase-lg p-showcase-xl min-h-[500px] font-showcase-body transition-all duration-300">
      ...
      <div className="flex justify-between items-center mb-12">
        ...
        <nav className="flex gap-6 text-sm font-medium text-showcase-muted-foreground">
        ...
        <div className="flex gap-4 items-center">
          <a href="#" className="text-sm font-medium text-showcase-foreground">Sign in</a>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div>
          ...
          <h1 className="text-5xl font-extrabold leading-tight mb-6 font-showcase-heading text-showcase-foreground">Focus on what matters. <span className="text-showcase-primary">Achieve extraordinary things.</span></h1>
          <p className="text-showcase-muted-foreground text-lg mb-8 leading-relaxed">FocusAI helps professionals plan smarter, work faster, and achieve their goals with the power of artificial intelligence.</p>
          <div className="flex gap-4">
            <button className={`${btnPrimary} px-showcase-xl py-showcase-md rounded-showcase-lg font-medium shadow-showcase-md transition-colors`}>Get Started Free</button>
            <button className="px-showcase-xl py-showcase-md bg-showcase-surface text-showcase-foreground border border-showcase-border rounded-showcase-lg font-medium flex items-center gap-2 hover:bg-showcase-surface/80 transition-colors">Watch Demo</button>
          </div>
        </div>
